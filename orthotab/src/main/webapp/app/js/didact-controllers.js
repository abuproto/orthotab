...
.controller(
		...
		[
				...
				function($rootScope, $scope, Didact02) {
					...
					$scope.pathInfos = [{"loc":"M0,0 L0,0","cssClass":"masque"},{"loc":"M0,0 L0,0","cssClass":"masque"},{"loc":"M0,0 L0,0","cssClass":"masque"},{"loc":"M0,0 L0,0","cssClass":"masque"}];
					...
					$scope.enregistreCaseG = function(caseCombi, $event,
							ind) {
						if (caseCombi.active) {
					...
					$scope.enregistreCaseD = function(caseCombi, $event,
							ind) {
						if (caseCombi.active) {
							if($scope.caseGcourant == null){
								...
								if ($scope.caseGcourant.valeur == caseCombi.valeur) {
									...
									$scope.pathInfos[cptPath].loc = "M"+caseGCourant.loc.x+","+caseGCourant.loc.y+" L"+caseCombi.loc.x+","+caseCombi.loc.y;
...
orthotabControllers.controller('Didact06Ctrl', function($scope) {
	...
	$scope.caseCible = [{"cssClass":"btn-case-vide"},{"cssClass":"btn-case-vide"},{"cssClass":"btn-case-vide"},{"cssClass":"btn-case-vide"}];
	$scope.nbCaseCible = 4;
