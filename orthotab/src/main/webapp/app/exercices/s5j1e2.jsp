...
<body ng-app="orthotabApp" ng-init="niveau='s5j1e2';nbocc=13;optIntrus=false;nbIntrus=0;">
<div id="page">
	<div id="bloc-principal">
<div class="div-haut" ng-controller="ExercicesNavCtrl" ng-init="groupe='s5j1'">
