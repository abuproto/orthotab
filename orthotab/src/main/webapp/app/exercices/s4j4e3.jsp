...
<p align="center">
<button ng-repeat="case in rmCourant.listeCaseCible" ng-click="enregistreCaseH(case,$index)" class="boutonCase" ng-style="{'background-color' : case.backgrdStyle}">&nbsp;{{case.libelle}}&nbsp;</button>
</p>

<p align="center">
<button ng-repeat="case in rmCourant.listeCaseChoix" ng-click="enregistreCaseB(case)" class="boutonCase" ng-style="{'background-color' : case.backgrdStyle}">&nbsp;{{case.libelle}}&nbsp;</button>
</p>
