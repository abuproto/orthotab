...
public class Technique08Data extends TechniqueDataUtil {
	...
	private CalculATrou construitCalculATrouVariante(String[] tabterme, String signe, int resultat, int idtrou, int valTrou, String[] tabprop){
		CalculATrou calculATrou = new CalculATrou();
		calculATrou.setIdtrou(idtrou);
		...
		int nbterme = tabterme.length;
		
		for(int i=0;i<nbterme;i++){
			String terme = tabterme[i];
			if("TROU".equals(terme)){
				...
				Case caseTerme = new Case("",terme,evalueExpression(terme));
	...
	public List<CalculATrou> listeCalculATrou(String niveau) {
		...
		case "s5j3e3":
			signe="+";
			listeCalculATrou.add(construitCalculATrouVariante(new String[]{"10","TROU","40","6"},signe, 146, 2, 90, new String[]{"92","4","90","6"}));
			listeCalculATrou.add(construitCalculATrouVariante(new String[]{"12","12","TROU"}, signe, 84, 4, 60, new String[]{"20","60","14","44"}));
			listeCalculATrou.add(construitCalculATrouVariante(new String[]{"30","50","TROU","10"},signe, 110, 4, 20, new String[]{"20","50","40","10"}));
			listeCalculATrou.add(construitCalculATrouVariante(new String[]{"44","10","TROU","24"},signe, 128, 4, 50, new String[]{"10","50","120","70"}));
			listeCalculATrou.add(construitCalculATrouVariante(new String[]{"67","TROU","20","5"}, signe, 95, 2, 3, new String[]{"3","4","20","26"}));
			break;
		case "s5j4e3":
			...
			listeCalculATrou.add(construitCalculATrouRapide(18, 66, 84, 2, new String[]{"18+60+6+10","66+8+10","18+36+30"}, 1));
