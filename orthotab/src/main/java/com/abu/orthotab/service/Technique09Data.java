...
public class Technique09Data extends TechniqueDataUtil{
	...
	public List<RemettreOrdre> listeRemettreOrdre(String niveau){
		...
		case "s4j2e3":
			...
			listeRemettreOrdre.add(construitRemettreOrdre(new String[][]{{"+","1;3;5"},{"+","1;3;5"},{"+","1;3;5"},{"94","0;2;4;6"},{"10","0;2;4;6"},{"4","0;2;4;6"},{"50","0;2;4;6"},{"=","7"},{"158","8"}}));
			listeRemettreOrdre.add(construitRemettreOrdre(new String[][]{{"+","1;3"},{"+","1;3"},{"3","0;2;4"},{"124","0;2;4"},{"40","0;2;4"},{"=","5"},{"167","6"}}));
			break;
		case "s4j4e3":
			listeRemettreOrdre.add(construitRemettreOrdre(new String[][]{{"+","1;3"},{"+","1;3"},{"3","0;2;4"},{"127","0;2;4"},{"62","0;2;4"},{"=","5"},{"192","6"}}));
			listeRemettreOrdre.add(construitRemettreOrdre(new String[][]{{"+","1;3"},{"+","1;3"},{"2","0;2;4"},{"75","0;2;4"},{"98","0;2;4"},{"=","5"},{"175","6"}}));
			...
			listeRemettreOrdre.add(construitRemettreOrdre(new String[][]{{"+","1;3"},{"+","1;3"},{"1","0;2;4"},{"27","0;2;4"},{"139","0;2;4"},{"=","5"},{"167","6"}}));
